/* $Id: GL++.hh,v 2.1 2000/05/05 20:50:39 vinod Exp $ */
...
/*
  $Log: GL++.hh,v $
  Revision 2.1  2000/05/05 20:50:39  vinod
  Modifications to use vector functions for Vector classes

  Revision 2.0  2000/03/12 00:49:31  vinod
  Major revision number change

  Revision 1.1  2000/03/03 19:18:55  vinod
  OpenGL functions defined using various classes
