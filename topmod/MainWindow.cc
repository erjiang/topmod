...
void MainWindow::createActions() {
	...
	connect(printFaceListAct, SIGNAL(triggered()), this, SLOT(printFaceList()));

	printVertexListAct = new QAction(tr("Print &Vertex List"), this);
	sm->registerAction(printVertexListAct, "File Menu", "");
	printVertexListAct->setStatusTip(tr("Print Vertex List to the console"));
	connect(printVertexListAct, SIGNAL(triggered()), this, SLOT(printVertexList()));
	...
	connect(printEdgeListAct, SIGNAL(triggered()), this, SLOT(printEdgeList()));
	...
	connect(mPrintCVListAct, SIGNAL(triggered()), this, SLOT(printCVList()));
	...
	connect(showGridAct, SIGNAL(triggered()), this->getActive(), SLOT(toggleGrid()));
	...
	connect(shadedRendererAct, SIGNAL(triggered()), this, SLOT(useShadedRenderer()));
	...
	mRendererActionGroup->addAction(shadedRendererAct);
	...
	connect(assignTextureCoordinatesAct, SIGNAL(triggered()), this, SLOT(randomAssignTexCoords()));
