/* $Id: DLFLConvexHull.cc,v 4.1 2004/01/20 09:26:59 vinod Exp $ */
...
bool DLFLConvexHull :: doubleTriangle(void)
{
...
bool DLFLConvexHull :: constructHull(void)
{
...
/*
  $Log: DLFLConvexHull.cc,v $
  Revision 4.1  2004/01/20 09:26:59  vinod
  Added code for column modeling
  ...
  Revision 2.5  2003/07/23 07:13:52  vinod
  Modified to return boolean indicating exclusion of vertex from convex hull

  Revision 2.4  2003/07/07 06:59:39  vinod
  Changed 0.0 to 0 for integer comparison in addOne method

  Revision 2.3  2003/04/18 21:31:07  vinod
  Moved createHull code to source file

  Revision 2.2  2003/04/14 17:20:18  vinod
  Added missing return statement in constructHull
