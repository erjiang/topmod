...
/* Since the include file under /usr/include/gl/ is totally screwed up with everything
   that is required commented out, this is a copy of that file with stuff that is needed
   uncommented */
