...
<profile>
	<property name="name">TopMod</property>
	<property name="title">TopMod</property>
	<property name="applicationicon">images/handbook.png</property>
	<property name="startpage">index.html</property>
	<property name="aboutmenutext">About TopMod</property>
	<property name="abouturl">about.txt</property>
	<property name="assistantdocs">.</property>
</profile>

<DCF ref="index.html" icon="images/handbook.png" title="TopMod">
	<section ref="./index.html" title="Welcome to TopMod">
